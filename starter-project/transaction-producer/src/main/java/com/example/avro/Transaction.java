...
public class Transaction extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9152030843044723485L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Transaction\",\"namespace\":\"com.example.avro\",\"fields\":[{\"name\":\"order_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"user_id\",\"type\":\"int\"},{\"name\":\"amount\",\"type\":\"double\"},{\"name\":\"status\",\"type\":{\"type\":\"enum\",\"name\":\"Status\",\"symbols\":[\"PENDING\",\"SUCCESS\",\"FAILED\"]}},{\"name\":\"timestamp\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}}]}");
  ...
  private com.example.avro.Status status;
   ...
   */
  public Transaction(java.lang.String order_id, java.lang.Integer user_id, java.lang.Double amount, com.example.avro.Status status, java.time.Instant timestamp) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: status = (com.example.avro.Status)value$; break;
   ...
   */
  public com.example.avro.Status getStatus() {
    return status;
  }
   ...
   */
  public static com.example.avro.Transaction.Builder newBuilder() {
    return new com.example.avro.Transaction.Builder();
  }
   ...
   * @return A new Transaction RecordBuilder
   */
  public static com.example.avro.Transaction.Builder newBuilder(com.example.avro.Transaction.Builder other) {
    if (other == null) {
      return new com.example.avro.Transaction.Builder();
    } else {
      return new com.example.avro.Transaction.Builder(other);
    }
  }
   ...
   * @return A new Transaction RecordBuilder
   */
  public static com.example.avro.Transaction.Builder newBuilder(com.example.avro.Transaction other) {
    if (other == null) {
      return new com.example.avro.Transaction.Builder();
    } else {
      return new com.example.avro.Transaction.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Transaction>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.avro.Transaction.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.avro.Transaction other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.order_id)) {
        this.order_id = data().deepCopy(fields()[0].schema(), other.order_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Transaction.Builder setOrderId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Transaction.Builder clearOrderId() {
      order_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Transaction.Builder setUserId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Transaction.Builder clearUserId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Transaction.Builder setAmount(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Transaction.Builder clearAmount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Transaction.Builder setStatus(com.example.avro.Status value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Transaction.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Transaction.Builder setTimestamp(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.avro.Transaction.Builder clearTimestamp() {
    ...
    public Transaction build() {
      try {
        ...
        record.status = fieldSetFlags()[3] ? this.status : (com.example.avro.Status) defaultValue(fields()[3]);
